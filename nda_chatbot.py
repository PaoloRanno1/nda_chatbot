...
Original file is located at
    https://colab.research.google.com/drive/1O_WMVJsuCl-DjOVzfjQ8UomMP3vjpiAl
"""
...
Answer:"""
    ...
    def chat_with_nda(self, user_message: str) -> Dict[str, Any]:
        """Main chat interface for NDA analysis"""
        if not self.documents:
            return {
        ...
        if intent == "SUMMARIZE":
            ...
            # Answer questions about the NDA
            ...
            general_prompt = f"""You are an NDA analysis assistant. The user has loaded an NDA document and is having a general conversation with you.
